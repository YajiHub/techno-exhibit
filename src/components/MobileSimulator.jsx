        ...
        {tab === 'contacts' && (
          <div className="p-5 space-y-5">
            ...
            <div className="bg-gradient-to-b from-blue-900/30 to-black border-2 border-blue-700/50 p-4 rounded-lg text-[9px]">
              ...
              {showTwilioInput && (
                <div className="space-y-3">
                  <input
                    type="text" placeholder="Account SID"
            ...
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-5 rounded-2xl border-2 border-brand/50 space-y-3 shadow-lg">
              ...
              <input placeholder="Phone (+63...)"
                className="w-full bg-black border-2 border-gray-700 focus:border-brand p-3 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none"
                value={form.phone} onChange={e => setForm({ ...form, phone: e.target.value })} />
              <input placeholder="Email"
                className="w-full bg-black border-2 border-gray-700 focus:border-brand p-3 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none"
                value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} />
              <input placeholder="Facebook ID (opt)"
                className="w-full bg-black border-2 border-gray-700 focus:border-brand p-3 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none"
                value={form.facebook} onChange={e => setForm({ ...form, facebook: e.target.value })} />
              <button onClick={handleAddContact}
                className="w-full bg-gradient-to-r from-brand to-yellow-400 text-black font-black py-4 rounded-xl text-[13px] uppercase tracking-wider shadow-lg hover:shadow-brand/50 transition-all hover:scale-105">
                ✓ Add Contact
              </button>
            </div>
          </div>
